...
const theme = (darkMode, color) => ({
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : 'rgb(254, 198, 0)',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : 'rgb(254, 198, 0)',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, rgb(254, 198, 0) 30 0%, #fff 0%)`
})
